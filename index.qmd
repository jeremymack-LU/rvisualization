...
## Topic 2: Static Visualizations {data-menu-title="extensions"}
...
## Topic 2: Static Visualizations {data-menu-title="patchwork"}
...
## Topic 2: Static Visualizations {data-menu-title="patchwork1"}
...
## Topic 2: Static Visualizations {data-menu-title="patchwork2"}
...
## Topic 2: Static Visualizations {data-menu-title="patchwork3"}
...
## Topic 2: Static Visualizations {data-menu-title="patchwork4"}
...
## Topic 2: Static Visualizations {data-menu-title="ggthemes"}
...
## Topic 2: Static Visualizations {data-menu-title="ggstatsplot"}
...
anim <- ggplot(data=gapminder,
    ...
    theme(panel.background=element_rect(color="black", fill="lightyellow", linewidth=0.25),
...
## Topic 3: Dynamic Visualizations {data-menu-title="integrations"}
...
## Topic 3: Dynamic Visualizations {data-menu-title="plotly"}
...
## Topic 3: Dynamic Visualizations {data-menu-title="plotly" auto-animate="true"}
...
## Topic 3: Dynamic Visualizations {data-menu-title="rayshader"}
...
![](images/rayshader_hex.png){.absolute top="52" right="0" width="30%"}

## Topic 3: Dynamic Visualizations {data-menu-title="rayshader" auto-animate="true"}

![](images/smtn_3D.png){.absolute top="90" left="0"}
...
::: {.fragment .fade-in-then-out fragment-index=1 .absolute top="40" left="100"}
![](images/smtn_raster.png){width="90%"}
:::
...
::: {.fragment .fade-in-then-out fragment-index=1 .absolute top="40" left="150"}
![](images/smtn_3D_2.png){width="750"}
:::
...
## Review - Data Visualization with R: {data-background="#000000" data-menu-title="Review 4 - Data"}

-   [**Grammar of graphics**]{style="color:#edea2b"} - basis for many data visualization programs

-   `ggplot2` is a popular implementation:

    - Layered approach with sensible defaults</br>
      ![](images/ggplot.png){width="35%"}
    
    :::fragment
    - Extension packages extend the functionality of `ggplot2`
      - `patchwork`, `ggthemes`, `ggstatsplot`, `gganimate`
    - Integration packages integrate ggplot objects into their own functions
      - `plotly`, `rayshader`
    :::

![](images/ggplot2_hex.png){.absolute bottom="0" right="0" width="170"}
![](images/tidyverse_hex.png){.absolute bottom="0" right="175" width="170"}
![](images/patchwork_hex.png){.absolute bottom="0" right="350" width="170"}

# Topic 4 {data-menu-title="Topic 4"}

[Shiny Apps - a preview]{style="font-size: 1.5em; text-align: center"}

## Topic 4: Shiny Apps - a preview {data-menu-title="Shiny Apps"}
